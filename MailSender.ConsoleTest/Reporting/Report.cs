...
namespace MailSender.ConsoleTest.Reporting
{
    public class Report
    {
        ...
        {
            ThumbnailPart thumbnailPart1 = document.AddNewPart<ThumbnailPart>("image/x-emf", "rId2");
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            Paragraph paragraph1 = new Paragraph() { RsidParagraphMarkRevision = "00274858", RsidParagraphAddition = "00186070", RsidRunAdditionDefault = "00274858", ParagraphId = "0E865E2B", TextId = "453B53DE" };
            ...
            Run run1 = new Run() { RsidRunProperties = "00274858" };
            ...
            Paragraph paragraph2 = new Paragraph() { RsidParagraphAddition = "00274858", RsidRunAdditionDefault = "00274858", ParagraphId = "100D49FD", TextId = "68DC1652" };
            ...
            Paragraph paragraph3 = new Paragraph() { RsidParagraphMarkRevision = "00274858", RsidParagraphAddition = "00274858", RsidParagraphProperties = "00274858", RsidRunAdditionDefault = "00274858", ParagraphId = "5E513675", TextId = "7A403D80" };

            ParagraphProperties paragraphProperties3 = new ParagraphProperties();
            Shading shading1 = new Shading() { Val = ShadingPatternValues.Clear, Color = "auto", Fill = "FF0000" };

            ParagraphMarkRunProperties paragraphMarkRunProperties3 = new ParagraphMarkRunProperties();
            Bold bold1 = new Bold();
            Color color3 = new Color() { Val = "FFFF00" };
            ...
            Run run2 = new Run() { RsidRunProperties = "00274858" };

            RunProperties runProperties2 = new RunProperties();
            Bold bold2 = new Bold();
            Color color4 = new Color() { Val = "FFFF00" };
            ...
            SectionProperties sectionProperties1 = new SectionProperties() { RsidRPr = "00274858", RsidR = "00274858" };
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            RsidRoot rsidRoot1 = new RsidRoot() { Val = "00D603B3" };
            Rsid rsid1 = new Rsid() { Val = "00186070" };
            Rsid rsid2 = new Rsid() { Val = "00274858" };
            Rsid rsid3 = new Rsid() { Val = "005778AA" };
            Rsid rsid4 = new Rsid() { Val = "005B78AE" };
            Rsid rsid5 = new Rsid() { Val = "00BA5836" };
            Rsid rsid6 = new Rsid() { Val = "00D603B3" };
            ...
            W14.DocumentId documentId1 = new W14.DocumentId() { Val = "0A6FCD06" };
            W15.ChartTrackingRefBased chartTrackingRefBased1 = new W15.ChartTrackingRefBased();
            W15.PersistentDocumentId persistentDocumentId1 = new W15.PersistentDocumentId() { Val = "{8EC7FD01-DEB5-4B7B-8A81-3669497322AF}" };
        ...
        private void GenerateStyleDefinitionsPart1Content(StyleDefinitionsPart styleDefinitionsPart1)
        {
            ...
            runPropertiesBaseStyle1.Append(languages6);
            ...
            Rsid rsid7 = new Rsid() { Val = "00BA5836" };
            ...
            Rsid rsid8 = new Rsid() { Val = "00BA5836" };

            StyleParagraphProperties styleParagraphProperties2 = new StyleParagraphProperties();
            KeepNext keepNext1 = new KeepNext();
            KeepLines keepLines1 = new KeepLines();
            SpacingBetweenLines spacingBetweenLines3 = new SpacingBetweenLines() { Before = "240", After = "0" };
            ...
            Rsid rsid9 = new Rsid() { Val = "00BA5836" };
            ...
            Rsid rsid10 = new Rsid() { Val = "00BA5836" };
            ...
            Style style8 = new Style() { Type = StyleValues.Character, StyleId = "20", CustomStyle = true };
            StyleName styleName8 = new StyleName() { Val = "Заголовок 2 Знак" };
            ...
            Rsid rsid11 = new Rsid() { Val = "00BA5836" };
            ...
            UIPriority uIPriority8 = new UIPriority() { Val = 10 };
            PrimaryStyle primaryStyle4 = new PrimaryStyle();
            Rsid rsid12 = new Rsid() { Val = "00BA5836" };
            ...
            StyleName styleName10 = new StyleName() { Val = "Заголовок Знак" };
            BasedOn basedOn6 = new BasedOn() { Val = "a0" };
            LinkedStyle linkedStyle6 = new LinkedStyle() { Val = "a3" };
            UIPriority uIPriority9 = new UIPriority() { Val = 10 };
            Rsid rsid13 = new Rsid() { Val = "00BA5836" };
        ...
        private void GenerateThemePart1Content(ThemePart themePart1)
        {
            ...
            A.FontScheme fontScheme1 = new A.FontScheme() { Name = "Гост 7.32" };
        ...
        private void SetPackageProperties(OpenXmlPackage document)
        {
            ...
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2019-04-16T17:59:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2019-04-16T18:00:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.LastModifiedBy = "Павел Шмачилин";
        }

        #region Binary Data
        private string thumbnailPart1Data = "";
